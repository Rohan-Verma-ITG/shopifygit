...
class CartPerformance {
  ...
  document.addEventListener('DOMContentLoaded', async function () {
    ...
    const loader = container.querySelector('.loading__spinner');
    ...
    for (let productHandle of wishlist) {
      try {
 ...
 const productHTML = `
  <div class="wishlist-item" data-handle="${product.handle}">
    ...
    <button class="remove-from-wishlist" data-handle="${product.handle}">
      Remove
    </button>
...
`;
        ...
        console.log('Error loading product:', productHandle);
      }
    }
  });
  ...
  const productCard = document.querySelector(
    `.wishlist-item[data-handle="${handle}"]`
  );
